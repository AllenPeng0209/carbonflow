...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'model-config': 'Configure MCP calls, prompt templates, and model behavior',
};
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'model-config', visible: true, window: 'user' as const, order: 7 },
  ...
  { id: 'model-config', visible: true, window: 'developer' as const, order: 13 },
];
