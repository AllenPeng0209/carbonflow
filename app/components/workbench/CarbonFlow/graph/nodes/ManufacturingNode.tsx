...
export const ManufacturingNode = ({ data }: ManufacturingNodeProps) => {
  ...
  console.log('[ManufacturingNode] 桑基图模式:', {
    nodeId: data.nodeId,
    isSankeyMode,
  });
  ...
  return (
    <div className="node manufacturing-node" data-activity-score={getActivityScore(data.activityScorelevel)}>
      ...
      <div className="node-content">
        ...
        <div className="node-info">
          <div className="info-item">
            <span className="label">制造工艺:</span>
